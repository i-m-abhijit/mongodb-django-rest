from mongodb.errors import OperationError
...
class QuerySet(BaseQuerySet):
    ...
    Wraps a MongoDB cursor, providing :class:`~mongodb.Document` objects as
    the results.
    """
    ...
    def __iter__(self):
        ...
        return self._iter_results() if self._has_more else iter(self._result_cache)
    ...
    def _populate_cache(self):
        ...
        """
        self._result_cache = self._result_cache or []
    ...
    def no_cache(self):
        ...
        return self._clone_into(QuerySetNoCache(
            self._document, self._collection))
